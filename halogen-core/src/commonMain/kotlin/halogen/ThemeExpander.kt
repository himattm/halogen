...
public object ThemeExpander {
     ...
     *
     * Performance optimization (Bolt): Manual array iteration and bitwise shifts are used
     * instead of string manipulation (like `substring().toLong(16)`) to avoid platform-specific
     * string allocation overhead in hot paths.
     */
     ...
     *
     * Performance optimization (Bolt): Manual character array construction and bitwise shifts
     * are used instead of `toString(16).padStart(6, '0').uppercase()` to avoid significant
     * string allocation and intermediate object creation overhead.
     */
